# firebase_core_tvos — porting report

Generated by `flutter-tvos plugin port` on 2026-06-30.

Source: `firebase_core` 4.11.0 (path: `/Users/aliustaoglu/.pub-cache/hosted/pub.dev/firebase_core-4.11.0`)
Base platform: ios (Objective-C)
Output: `./firebase_core_tvos`
...
Manual review required. Read this report top-to-bottom before publishing `firebase_core_tvos`.
