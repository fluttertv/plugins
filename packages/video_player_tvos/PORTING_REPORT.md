# video_player_tvos — porting report

Generated by `flutter-tvos plugin port` on 2026-05-18.

Source: `video_player_avfoundation` 2.9.6 (path: `/Users/aliustaoglu/.pub-cache/hosted/pub.dev/video_player_avfoundation-2.9.6`)
Base platform: ios (Swift)
Output: `./video_player_tvos`
...
Manual review required. Read this report top-to-bottom before publishing `video_player_tvos`.
