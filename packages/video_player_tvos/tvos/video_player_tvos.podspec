...
# Run `pod lib lint video_player_tvos.podspec` to validate before publishing.
#
# Generated by `flutter-tvos plugin port`. License holder: The FlutterTV Authors.
#
Pod::Spec.new do |s|
  s.name             = 'video_player_tvos'
  s.version          = '0.0.1'
  s.summary          = 'tvOS implementation of video_player.'
  s.description      = <<-DESC
tvOS implementation of video_player, the federated platform
package that ships native code targeting Apple tvOS.
                       DESC
  s.homepage         = 'https://github.com/fluttertv/video_player_tvos'
