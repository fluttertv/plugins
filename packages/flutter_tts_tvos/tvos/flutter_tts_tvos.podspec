...
# Run `pod lib lint flutter_tts_tvos.podspec` to validate before publishing.
#
# Generated by `flutter-tvos plugin port`. License holder: The FlutterTV Authors.
#
Pod::Spec.new do |s|
  s.name             = 'flutter_tts_tvos'
  s.version          = '0.0.1'
  s.summary          = 'tvOS implementation of flutter_tts.'
  s.description      = <<-DESC
tvOS implementation of flutter_tts, the federated platform
package that ships native code targeting Apple tvOS.
                       DESC
  s.homepage         = 'https://github.com/fluttertv/flutter_tts_tvos'
