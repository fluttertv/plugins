...
// Disabled on tvOS by hand — see FLTFirebaseAuthPlugin.m for why
// FIRTOTPSecret's interface isn't visible on tvOS (it's the only caller of
// this method, and is itself disabled).
#if !TARGET_OS_TV
